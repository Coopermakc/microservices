...
class Metrics
  ...
  def initialize app
    ...
    @request_count = Prometheus::Client::Counter.new(:ui_request_count, docstring: 'App Request Count')
    @request_latency = Prometheus::Client::Histogram.new(:ui_request_latency_seconds, docstring: 'Request latency')
